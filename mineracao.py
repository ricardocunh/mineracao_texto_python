...
# Realizando a stopwords com NLTK
...
def aplicastemmer(texto):
        ...
        frasesstemming = []
        for (palavras, emocao) in texto:
                comstemming = [str(stemmer.stem(p)) for p in palavras.split() if stopwordsnltk]
...
# Criando uma função sem as emoções associadas
...
# Extração de palavras unicas não repetidas
...
# realizando a impressão das primeiras 50 palavras
#print(frequencia.most_common(50))

# Retornar a lista de palavras unicas
...
# Quais são os registros que ele está apontando como erros
erros = []
...
#previsto = 'alegria alegria medo surpresa medo medo medo supresa'.split()
matriz = ConfusionMatrix(esperado, previsto)
print(matriz)

# 1. Verificar o cenário
